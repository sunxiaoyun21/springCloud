...
import com.demo.annotation.LocalCacheRemove;
...
public class LocalCacheAop {
     ...
     * LocalCache切入点规则
     */
    @Pointcut(value = "@annotation(com.demo.annotation.LocalCache)")
     ...
     */
    @Pointcut(value = "@annotation(com.demo.annotation.LocalCacheRemove)")
